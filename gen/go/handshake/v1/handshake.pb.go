...
// Defines a message for SerializedKeys equivalent to the Go struct
type SerializedKeys struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PKEPublicKey  []byte `protobuf:"bytes,1,opt,name=PKEPublicKey,proto3" json:"PKEPublicKey,omitempty"`   // Maps Go's []byte to proto's bytes type
	NIKEPublicKey []byte `protobuf:"bytes,2,opt,name=NIKEPublicKey,proto3" json:"NIKEPublicKey,omitempty"` // Maps Go's []byte to proto's bytes type
}
...
type HandshakeReq struct {
	...
	Keys     *SerializedKeys `protobuf:"bytes,4,opt,name=keys,proto3" json:"keys,omitempty"` // References another message type for the pointer to SerializedKeys
}
...
var file_handshake_v1_handshake_proto_rawDesc = []byte{
	...
	0x08, 0x70, 0x65, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x42, 0xb9, 0x01, 0x0a, 0x10, 0x63, 0x6f,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x68, 0x61,
	0x6e, 0x64, 0x73, 0x68, 0x61, 0x6b, 0x65, 0x2f, 0x76, 0x31, 0x3b, 0x68, 0x61, 0x6e, 0x64, 0x73,
	0x68, 0x61, 0x6b, 0x65, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x48, 0x58, 0x58, 0xaa, 0x02, 0x0c, 0x48,
	0x61, 0x6e, 0x64, 0x73, 0x68, 0x61, 0x6b, 0x65, 0x2e, 0x56, 0x31, 0xca, 0x02, 0x0c, 0x48, 0x61,
	0x6e, 0x64, 0x73, 0x68, 0x61, 0x6b, 0x65, 0x5c, 0x56, 0x31, 0xe2, 0x02, 0x18, 0x48, 0x61, 0x6e,
	0x64, 0x73, 0x68, 0x61, 0x6b, 0x65, 0x5c, 0x56, 0x31, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0d, 0x48, 0x61, 0x6e, 0x64, 0x73, 0x68, 0x61, 0x6b,
