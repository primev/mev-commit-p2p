package userregistrycontract_test
...
func TestUserRegistryContract(t *testing.T) {
	t.Parallel()
	...
	t.Run("RegisterUser", func(t *testing.T) {
		...
		expCallData, err := userregistrycontract.UserRegistryABI().Pack("registerAndStake")
		if err != nil {
			t.Fatal(err)
		}
		...
		err = registryContract.RegisterUser(context.Background(), amount)
		if err != nil {
			t.Fatal(err)
		}
	})
	...
	t.Run("GetStake", func(t *testing.T) {
		...
		expCallData, err := userregistrycontract.UserRegistryABI().Pack("checkStake", address)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("GetMinimalStake", func(t *testing.T) {
		...
		expCallData, err := userregistrycontract.UserRegistryABI().Pack("minStake")
		if err != nil {
			t.Fatal(err)
		}
